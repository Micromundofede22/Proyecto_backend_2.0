...
export default class ProductMongoDAO {
    ...
    update = async (id, data) => await productModel.findByIdAndUpdate(id, data, { returnDocument: "after" }) //resturnDocument me retorna el documento actualizado luego de actualizar, sino devuelve el documento original
